...
namespace RiderData
{
    public static class NewRider
    {
        ...
        {
            NewRider.Kart_Old_Cut = 281;
            NewRider.MaxKart = 1098;
            ...
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                for (short i = 1; i <= NewRider.MaxKart; i++)
                {
                    if (i <= 25 || i == 27 || i == 29 || i == 45 || i == 54 || i == 59 ||
                        ...
                        i == 1074 || i == 1078 || i == 1079 || i == 1080 || i == 1085 || i == 1086 || i == 1087 || i == 1089 || i == 1090 || i == 1095 || i == 1098)
                    {
        ...
        public static void Character()
        {
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                oPacket.WriteInt(1);
                int Character = 244;
                oPacket.WriteInt(Character - 30 - 27);
                for (short i = 1; i <= Character; i++)//Character
                {
                    if (i == 47 || i == 48 || i == 63 || i == 116 || i == 117 || i == 122 || i == 124 || i == 128 || i == 130 || i == 134 || 
                        ...
                        i == 184 || i == 192 || i == 193 || i == 194 || i == 195 || i == 196 || i == 197 || i == 231 || i == 238 || i == 239 || 
        ...
        public static void Aura()
        {
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                {
                    if (i == 28 || i == 33 || i == 35 || i == 46 || i == 53 || i == 54 || i == 58 || i == 59)
                    {
                    }
                    else
                    {
            ...
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                for (short i = 1; i <= 1134; i++)
                {
                    if (i == 71 || i == 74 || i == 118 || i == 125 || i == 139 || i == 142 || i == 149 || i == 162 || i == 182 || i == 187 ||
                        ...
                        i == 1098 || i == 1112 || i == 1113 || i == 1114 || i == 1119 || i == 1122 || i == 1123 || i == 1134 || 
